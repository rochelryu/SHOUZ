...
class PageIndicatorThree extends StatelessWidget {
  final int _counter;
  final pageCount;
  PageIndicatorThree(this._counter,this.pageCount);
  ...
  Widget build(BuildContext context) {
    return new Row(
      children: _buildPageIndicatorThree(),
    );
  }
}
