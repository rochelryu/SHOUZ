                  ...
                  child: Container(
                    ...
                    child: TypeAheadField(
                      ...
                      onSelected: (suggestion) async {
                        ...
                        final inforDecode = widget.type == 1
                            ? await consumeAPI.decodeTicketEventByNumero(
                                widget.idOfType, user['numero'])
                            : await consumeAPI.decodeTicketTravelByNumero(
                                widget.idOfType, user['numero']);
                        if (inforDecode['etat'] == 'found') {
                          ...
                          await askedToLead(
                              inforDecode['result'], true, context);

                          eCtrl.text = '';
                          if (inforDecode['result'] !=
                        ...
                        } else if (inforDecode['etat'] == 'notFound' &&
                            inforDecode['etat'] ==
                          ...
                          await askedToLead(
                              inforDecode['error'], false, context);
                        }
                      },
                    ),
                  ),
